...
def add_prediction(input_data):
    ...
    if prediction[0]==0:
        st.subheader(":green[Benign]")
    else:
        st.subheader(":red[Malignant]")
...
def app():
    ...
    with st.container():
        ...
        st.write("This app predicts using a machine learning model whether a breast mass is Benign or Malignant. You can update the measurements by the sliders in the sidebar.")
